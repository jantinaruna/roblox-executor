...
<p align="center">
  <code>.NET 10</code> &nbsp;·&nbsp; <code>MIT</code> &nbsp;·&nbsp; <code>RbExec</code> &nbsp;·&nbsp; <code>rbexec</code>
</p>
...
Roblox executor shell — Lua attach pipeline, script hub browser, instance list.

roblox-executor is the evergreen search string in that community.
...
```bash
dotnet restore roblox-executor.slnx
dotnet build roblox-executor.slnx -c Release
dotnet test roblox-executor.slnx -c Release
```
